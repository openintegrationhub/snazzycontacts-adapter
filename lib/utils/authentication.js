...
async function getToken(config) {
  ...
  const uri = config.devMode === true ? 'https://dev-api.snazzyapps.de/api/iam/login' : 'https://api.snazzycontacts.com/api/iam/login';
  ...
  const options = {
    ...
    body: {
      ...
      password: (config.passphrase) ? config.passphrase : config.password,
    },
  };

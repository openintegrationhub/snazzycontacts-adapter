...
async function processAction(msg, cfg) {
  ...
  async function emitData() {
    const reply = await upsertPerson(msg, token);
...
async function upsertPerson(msg, token) {
  try {
    const uri = 'http://api.snazzyapps.de/api/person';
    ...
    console.log('STATUS: ', person.statusCode);

...
async function processAction(msg, cfg) {
  ...
  const recordUid = (msg.body.meta != undefined && msg.body.meta.uid != undefined) ? msg.body.meta.uid : 'uid not set yet';
  // TODO: fix recordUid

  async function emitData() {
    console.log('META: ', msg.body.meta);
    console.log('==============');
    console.log('DATA: ', msg.body.data);

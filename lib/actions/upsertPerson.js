...
function resolveConflict(incomingObject, appObject) {
  // console.log('INCOMING OBJECT: ', JSON.stringify(incomingObject.body, undefined, 2));
  // console.log('============');
  // console.log('APP OBJECT: ', JSON.stringify(appObject, undefined, 2));
  console.log('APP OBJECT: ', appObject.body);

...
async function processTrigger(msg, cfg, snapshot = {}) {
  ...
  async function emitData() {
    ...
    */
    ...
    let count;
    const getCount = await getEntries(token, snapshot, count, 'organization', cfg.devMode);
    count = getCount.count; // eslint-disable-line

    const organizations = await getEntries(token, snapshot, count, 'organization', cfg.devMode);
